import {styleLoad, checkCompDate, sortingArrByDate, toggleH2, getDataFromCookie} from './style-loading.js';
...
function writeHwList(element, item){
   ...
   <td class="subject"> ${item.task.subjectOnCourse.subjectName} </td> <td class="task"> ${item.task.task} </td> </tr>`;
}
